...
const msgList = ["小白小在8秒前提交了ai画册", "456在3秒前开启了ai画册", "小黑在8秒前提交了ai画册", "小白小在8秒前提交了ai画册", "小白小在8秒前提交了ai画册", "小白小在8秒前提交了ai画册", "123"]
const size = 5;
 ...
 */
const initCarouserList = (msgList = [""], size = 3, container = document.querySelector('.carouselList-container')) => {
    // 绘制列表
...
async function addSlide(msg, container = document.querySelector('.carouselList-container')) {
    ...
    await mySleep(400);  // Match the duration of the transition
