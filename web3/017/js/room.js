...
{	
	...
	//词云
	const carData = ["朗逸", "轩逸", "速腾", "宝来", "拉罗拉", "英朗", "桑塔纳", "思域", "雷凌", "雅阁", "凌派", "逸动", "帝豪", "远景", "悦动", "长安CS55", "瑞虎8", "逸动DT", "奔腾B70", "博瑞", "启辰D60", "瑞虎5X", "艾瑞泽GX", "瑞纳VTi-S", "途岳", "风光580", "凌云S", "天籁", "S90进口", "S90长轴距版", "S60L T4智进版",
		"S60L T3智进版", "S40进取版", "S80L T5智进版", "S90L进取版", "S60L T5智进版", "S60L T4智远版", "S90L智进版", "S60L T6智进版", "S90L智远版"]
	var cloudData=[];

	for(var i=0;i<30;i++)
	{
		cloudData.push({name:carData[i],value:Math.random()*1000});
	}
